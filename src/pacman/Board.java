...
public class Board extends JPanel implements ActionListener{
	...
	private final int MAX_GOSTS = 12;
	private final int PACMAN_SPEED = 6;
	
	private int pacAnimCount = PAC_ANIM_DELAY;
	private int pacAnimDir = 1;
	private int pacAnimPos = 0;
	private int N_GOSTS = 6;
	private int pacsLeft, score;
	private int[] dx, dy;
	private int[] ghosts_x, ghosts_y, ghosts_dx, ghosts_dy, ghostSpeed;
	...
	private void initVariables() {
		...
		ghosts_x = new int [MAX_GOSTS];
		ghosts_dx = new int [MAX_GOSTS];
		ghosts_y = new int [MAX_GOSTS];
		ghosts_dy = new int [MAX_GOSTS];
		ghostSpeed = new int [MAX_GOSTS];
		dx = new int[4];
		dy = new int[4];
...
pacsLeft--;
	...
	private void moveGhosts(Graphics2D g2d) {
		...
		for(i = 0; i< N_GOSTS; i++) {
			...
			ghosts_x[i] = ghosts_x[i] + (ghosts_dx[i]*ghostSpeed[i]);
			ghosts_y[i] = ghosts_y[i] + (ghosts_dy[i]*ghostSpeed[i]);
...
private void checkMaze() {
	...
	private void drawGhost(Graphics2D g2d, int i, int j) {
		// TODO Auto-generated method stub

		g2d.drawImage(ghost, i, j, this);
	}
